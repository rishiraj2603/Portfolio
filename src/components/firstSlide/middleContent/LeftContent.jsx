...
const LeftContent = () => {
  return (
    <div className=" flex h-[89.5%] w-[100%] relative">
      <div className="h-[100%] w-[20%] relative">
        ...
        <p className="rotate-270 absolute top-170 left-9">present</p>
      </div>
      ...
      <div className="flex flex-col justify-center gap-5 w-[80%]">
        ...
        <p className="text-xl">
          "Programming isn't about what you know; <br /> it's about what you can
          figure out.” <br /> - Chris Pine
        </p>
      </div>
      <div
        style={{ clipPath: "polygon(100% 0, 0% 100%, 100% 100%)" }}
        className="h-[16.2%] w-[23%] bg-design-blue-block-600 absolute right-0 bottom-0"
      ></div>
    </div>
  );
};
